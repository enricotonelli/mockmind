  ...
  return (
    <div className="mx-auto max-w-3xl px-5 py-8 sm:px-8 sm:py-12">
      ...
      <Tarjeta className="mb-8">
        ...
        >
          ...
          <span className="text-xs font-medium text-texto-tenue">
            {verConversacion ? 'Ocultar' : 'Mostrar'}
          </span>
        </button>
      ...
      <div className="flex flex-wrap gap-3">
        <Boton tamano="grande" onClick={() => router.push('/entrevista/nueva')}>
          Practicar de nuevo
        </Boton>
        <Boton variante="secundario" tamano="grande" onClick={() => router.push('/historial')}>
          Ver mi evolución
        </Boton>
      </div>
    </div>
