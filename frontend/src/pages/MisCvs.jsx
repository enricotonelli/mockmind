  ...
  return (
    <div className="mx-auto max-w-4xl px-5 py-8 sm:px-8 sm:py-12">
      <header className="mb-8 flex flex-wrap items-end justify-between gap-3">
        ...
        {lista.length > 0 && (
          <Boton onClick={() => navegar('/cv/nuevo')}>+ Nuevo CV</Boton>
        )}
      </header>
      ...
      {lista.length === 0 ? (
        ...
        >
          <Boton onClick={() => navegar('/cv/nuevo')}>Crear mi primer CV</Boton>
        </EstadoVacio>
      ) : (
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  aria-label={`Eliminar el CV de ${item.nombre || 'sin nombre'}`}
