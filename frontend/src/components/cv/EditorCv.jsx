            ...
            {cv.habilidades.map((habilidad) => (
              ...
              >
                ...
                <button
                  ...
                  className="text-texto-tenue transition hover:text-acento"
            ...
            {cv.idiomas.map((item, indice) => (
              <div key={`${item.idioma}-${indice}`} className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="rounded-lg p-1.5 text-texto-tenue transition hover:text-acento"
                  aria-label={`Quitar ${item.idioma}`}
                >
                  ✕
                </button>
              </div>
